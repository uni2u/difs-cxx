 ...
 *     @endcode
 */
class HCSegmentFetcher : noncopyable
{
public:
  /**
   ...
   */
  static shared_ptr<HCSegmentFetcher>
  start(Face& face,
...
private:
  ...
  HCSegmentFetcher(Face& face, security::v2::Validator& validator, const Options& options);

  static bool
  shouldStop(const weak_ptr<HCSegmentFetcher>& weakSelf);
...
NDN_CXX_PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  shared_ptr<HCSegmentFetcher> m_this;
