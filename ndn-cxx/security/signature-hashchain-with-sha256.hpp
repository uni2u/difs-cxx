...
#ifndef NDN_SECURITY_HASHCHAIN_SHA256_HPP
#define NDN_SECURITY_HASHCHAIN_SHA256_HPP
...
[[deprecated("use SignatureInfo with type DigestSha256 instead")]]
#endif // DOXYGEN
SignatureHashChainWithSha256 : public Signature
{
public:
   ...
   */
  explicit
  SignatureHashChainWithSha256(const Signature& signature);
};

} // namespace ndn

#endif // NDN_SECURITY_HASHCHAIN_SHA256_HPP
