...
inline enum cpu_feature operator|(enum cpu_feature a, enum cpu_feature b)
{
  return static_cast<enum cpu_feature>(static_cast<int>(a) | static_cast<int>(b));
}
...
#if defined(BLAKE3_AVX512)
  if (features & AVX512VL) {
    blake3_compress_in_place_avx512(cv, block, block_len, counter, flags);
    return;
  }
#endif
#if defined(BLAKE3_SSE41)
  if (features & SSE41) {
